...
def print_kelompok():
    ...
    print_simple_table(["Nama", "NIM"], [
        ["Muhammad Nur Alam", "24241123"],
        ["Muhammad Baihaqi", "24241128"],
        ["Dodik Pratama", "24241140"],
    ])
...
def tugas2():
    ...
    print("Nama: muhammad nur alam")
    print("NIM: 24241123")
    print("Nama: muhammad baihaki")
    print("NIM: 24241128")
    print("Nama: dodik pratama")
    print("NIM: 24241140")

    while True:
        try:
            inputUser = int(input("\nMasukkan angka yang bernilai kurang dari 23 atau lebih dari 40: "))
            break
        except ValueError:
            print("Harap masukkan angka yang valid!")

    iskurangdari = (inputUser < 23)
    islebihdari = (inputUser > 40)
    final = iskurangdari or islebihdari

    print("\nHasil Pengecekan:")
    print_simple_table(["Kondisi", "Hasil"], [
        ["Angka < 23", iskurangdari],
        ["Angka > 40", islebihdari],
